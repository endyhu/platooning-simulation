    ...
    def __init__(self, lanes=3):
        ...
        for i in range(8):
            ...
            for j in range(self.lanes):
                sprite_img = road_mid_img
                
                if j != 0:
                    pos_y = pos_y - self.lane_width
                if j == 0:
                    sprite_img = road_top_img
                elif j == self.lanes - 1:
                    sprite_img = road_bot_img
                    
                self.road_sprites.append(pg.sprite.Sprite(sprite_img, pos_x, pos_y, batch=self.sprite_batch))
